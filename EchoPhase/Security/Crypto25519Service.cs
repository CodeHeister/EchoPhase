...
{
    public sealed class Crypto25519Service : ICrypto25519Service
    {
        private readonly SecureRandom _random;
        private readonly Crypto25519Settings _settings;

        public Crypto25519Service(IOptions<Crypto25519Settings> settings)
        {
            ...
            AeadChoice? aead = null)
        {
            ...
            var strategies = new Dictionary<AeadChoice, Func<EncryptedMessage>>()
            {
                [AeadChoice.AesGcm] = () =>
                {
                    ...
                    var tag = new byte[16];
                    using (var aes = new AesGcm(aeadKey, 16))
                    {
